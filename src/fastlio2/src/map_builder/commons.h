...
struct Config
{
    ...
    double nbg = 0.0001;
    int imu_init_num = 20;
    double imu_init_acc_norm_min = 8.0;
    double imu_init_acc_norm_max = 11.5;
    double imu_init_acc_std_max = 0.5;
    double imu_init_gyro_std_max = 0.05;
    int near_search_num = 5;
    int min_effective_points = 20;
